...
# ==
# 
# C bindings will be placed in ${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/c.  
#
...
# ==
# 
# C++ bindings will be placed in ${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/cpp.
#
...
#    ${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/java
#
...
#    ${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/python
# 
...
function(lcmtypes_build_c)
    ...
    set(_lcmtypes_c_dir ${INCLUDE_OUTPUT_PATH}/${PROJECT_NAME}/c)
    ...
    include_directories(BEFORE ${INCLUDE_OUTPUT_PATH}/${PROJECT_NAME}/c) #TODO: don't think this is necessary
    ...
    #    set_source_files_properties(${_lcmtypes_c_files} PROPERTIES COMPILE_FLAGS "-I${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/c")
    #    set_target_properties("${libname}-static" PROPERTIES OUTPUT_NAME "${libname}")
    ...
    pods_install_headers(${_lcmtypes_h_files} DESTINATION ${PROJECT_NAME})
    ...
    lcmtypes_add_clean_dir("${INCLUDE_OUTPUT_PATH}/${PROJECT_NAME}/c")
endfunction()
...
function(lcmtypes_build_cpp)
    ...
    set(_lcmtypes_cpp_dir ${INCLUDE_OUTPUT_PATH}/${PROJECT_NAME}/cpp)
    ...
    include_directories(BEFORE ${PROJECT_SOURCE_DIR}/${PROJECT_NAME}/cpp) #TODO: don't think this is necessary
    include_directories(${LCM_INCLUDE_DIRS})
    ...
    foreach(hpp_file ${_lcmtypes_hpp_files})
        ...
        pods_install_headers(${hpp_file} DESTINATION ${PROJECT_NAME}/${__tmp_dir})
    endforeach()
    file(APPEND ${__agg_hpp_fname} "\n#endif\n")
    pods_install_headers(${__agg_hpp_fname} DESTINATION ${PROJECT_NAME})
    unset(__sanitized_project_name)
    unset(__agg_hpp_fname)

 

    lcmtypes_add_clean_dir("${INCLUDE_OUTPUT_PATH}/${PROJECT_NAME}/cpp")
endfunction()
...
function(lcmtypes_install_types)
    ...
    install(FILES ${_lcmtypes} DESTINATION share/${PROJECT_NAME})
endfunction()
